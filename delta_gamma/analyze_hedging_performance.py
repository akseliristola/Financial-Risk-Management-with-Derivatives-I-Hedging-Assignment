...
def main():
    raw_path = "gamma_hedging_performance_raw.csv"
    summary_path = "gamma_hedging_performance_summary.csv"
    ...
    # Aggregate hedging error statistics and default ratio statistics
    summary = (
        ...
        .agg(
            ...
            min_mse=("mse", "min"),
            max_mse=("mse", "max"),
            # Optional: stats on fallback default ratio
            mean_default_ratio=("default_ratio", "mean"),
            max_default_ratio=("default_ratio", "max"),
        )
        .reset_index()
    )
